...
int main(int argc, char *argv[])
{
	...
	*/
	...
	/* attende la terminazione del thread th. Se ha successo, ritorna 0 e 
	   un puntatore al valore ritornato dal thread. Se non si vuole ricevere 
	   il valore di ritorno è sufficiente passare NULL come secondo parametro*/
	int *somma;
	// la firma è pthread_join(pthread_t th, void **thread_return) 
	// variante con restituzione valore
	pthread_join(tid,(void **)&somma);
...
void *runner(void *param) 
{
	...
	/* variazione in cui restituisco un valore con la exit che 
	restituisce un qualsiasi tipo di dato */
